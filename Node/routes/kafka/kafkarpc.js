...
KafkaRPC.prototype.setupResponseQueue = function(producer,topic_name, next){
    ...
    //changes start
    // Adding Signup Topic
    consumer.addTopics(['signup_topic_response'], function (error, done) {
        console.log(error, done);
    });
    //changes end

    // Adding Skill Topic
    consumer.addTopics(['skill_topic_response'], function (error, done) {
        console.log(error, done);
    });
    //changes end

    // Adding project Topic
    consumer.addTopics(['project_topic_response'], function (error, done) {
        console.log(error, done);
    });
    //changes end
